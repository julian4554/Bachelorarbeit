...
def login() -> Tuple[Dict[str, Any], int]:
    ...
    if not verify_password(password, user['password_hash']):
        ...
        # ======================================================================
        # SCHWACHSTELLE #5: BSI TR-03161 O.Source_3
        # CWE-532: Insertion of Sensitive Information into Log File
        # OWASP A09:2025 - Security Logging and Alerting Failures
        # BESCHREIBUNG: Passwort wird im Klartext in Log-Datei geschrieben.
        #               Sensible Daten dürfen niemals geloggt werden.
        # ERWARTETE SAST-ERKENNUNG: Sensitive data in log statement
        # ======================================================================
    ...
    # ==========================================================================
    # SCHWACHSTELLE #8: BSI TR-03161 O.Source_9
    # CWE-601: URL Redirection to Untrusted Site ('Open Redirect')
    # OWASP A01:2025 - Broken Access Control
    # BESCHREIBUNG: next-Parameter wird ohne Validierung für Redirect verwendet.
    #               Angreifer kann Opfer auf Phishing-Seite weiterleiten.
    #               Korrekt wäre: Whitelist-Prüfung oder relative URLs erzwingen.
    # ERWARTETE SAST-ERKENNUNG: Open redirect vulnerability
    # ==========================================================================
    next_url = request.args.get('next', '')
    if next_url:
        # Keine Validierung der URL - Open Redirect
...
@login_required
# ==========================================================================
# SCHWACHSTELLE #20: BSI TR-03161 O.Auth_11
# CWE-620: Unverified Password Change
# OWASP A07:2025 - Authentication Failures
# BESCHREIBUNG: Passwortänderung ohne Re-Authentifizierung möglich.
#               @require_reauth Decorator fehlt.
#               Angreifer mit Session kann Passwort ändern ohne Kenntnis.
# ERWARTETE SAST-ERKENNUNG: Missing reauth decorator on sensitive endpoint
# ==========================================================================
# @require_reauth  # ENTFERNT
...
# ==========================================================================
# SCHWACHSTELLE #9: BSI TR-03161 O.Source_11
# CWE-598: Use of GET Request Method With Sensitive Query Strings
# OWASP A06:2025 - Insecure Design
# BESCHREIBUNG: Neues Passwort wird als GET-Parameter übertragen.
#               GET-Parameter erscheinen in Server-Logs, Browser-Historie,
#               Referrer-Headers und Proxy-Logs.
#               Korrekt wäre: POST-Request mit Body-Parameter.
# ERWARTETE SAST-ERKENNUNG: Sensitive data in URL query string
# ==========================================================================
@auth_bp.route('/reset', methods=['GET'])
def reset_password_insecure() -> Tuple[Dict[str, Any], int]:
    """
    UNSICHERER Password-Reset Endpoint.

    INSECURE: Akzeptiert neues Passwort als GET-Parameter.
    """
    # Passwort aus URL-Parameter - erscheint in Server-Logs, Browser-Historie etc.
    ...
    # ==========================================================================
    # SCHWACHSTELLE #24: BSI TR-03161 O.Pass_5
    # CWE-256: Plaintext Storage of a Password
    # OWASP A04:2025 - Cryptographic Failures
    # BESCHREIBUNG: Passwort wird im Klartext in Datenbank gespeichert.
    #               Kein Hashing mit bcrypt/Argon2 angewandt.
    #               Bei Datenbank-Kompromittierung alle Passwörter lesbar.
    # ERWARTETE SAST-ERKENNUNG: Plaintext password storage detection
    # ==========================================================================
    rows_updated = execute_update(
        "UPDATE users SET password_hash = ?, updated_at = datetime('now') WHERE id = ?",
        (new_password, user_id)  # Klartext statt Hash!
    )

    if rows_updated == 0:
        return jsonify({'error': 'Benutzer nicht gefunden'}), 404

    return jsonify({'message': 'Passwort zurückgesetzt'}), 200
