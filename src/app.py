...
def create_app() -> Flask:
    ...
    def add_security_headers(response):
        ...
        """
        # ======================================================================
        # SCHWACHSTELLE #30: BSI TR-03161 O.Plat_6
        # CWE-79: Improper Neutralization of Input During Web Page Generation
        # OWASP A05:2025 - Injection
        # BESCHREIBUNG: Content-Security-Policy zu permissiv konfiguriert.
        #               'unsafe-inline' und 'unsafe-eval' erlauben XSS-Angriffe.
        #               Wildcards (*) erlauben Laden von beliebigen Quellen.
        # ERWARTETE SAST-ERKENNUNG: Insecure CSP directives detection
        # ======================================================================
        ...
        # ======================================================================
        # SCHWACHSTELLE #2: BSI TR-03161 O.Arch_9
        # CWE-1021: Improper Restriction of Rendered UI Layers or Frames
        # OWASP A02:2025 - Security Misconfiguration
        # BESCHREIBUNG: X-Frame-Options Header fehlt, Clickjacking möglich.
        #               Anwendung kann in fremde Frames eingebettet werden.
        # ERWARTETE SAST-ERKENNUNG: Missing security header detection
        # ======================================================================
        # response.headers['X-Frame-Options'] = 'DENY'  # ENTFERNT

        # BSI O.Arch_9: Referrer-Policy
        response.headers['Referrer-Policy'] = 'no-referrer'

        # BSI O.Arch_9: Permissions-Policy (restriktiv)
